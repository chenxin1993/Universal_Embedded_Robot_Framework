...
//	GpioCtrlRegs.GPAPUD.bit.GPIO29 = 0;	   // Enable pull-up for GPIO29 (SCITXDA)
	GpioCtrlRegs.GPBPUD.bit.GPIO35 = 0;	   // Enable pull-up for GPIO37 (SCITXDA)

/* Set qualification for selected pins to asynch only */
// Inputs are synchronized to SYSCLKOUT by default.  
// This will select asynch (no qualification) for the selected pins.

//	GpioCtrlRegs.GPAQSEL1.bit.GPIO28 = 3;  // Asynch input GPIO28 (SCIRXDA)
...
//	GpioCtrlRegs.GPAMUX2.bit.GPIO29 = 1;   // Configure GPIO29 for SCITXDA operation
	...
	GpioCtrlRegs.GPBMUX1.bit.GPIO35 = 1;   // Configure GPIO37 for SCITXDA operation
